...
class AddDeliveryAddress extends StatefulWidget {
  ...
  AddDeliveryAddress({this.amount, this.products});
...
class _AddDeliveryAddressState extends State<AddDeliveryAddress> {
  ...
  void initState() {
    ...
    phoneController.text = Provider.of<Authentication>(context, listen: false)
        ...
        .phoneNumber
        .toString();
    // mobileController.text = Provider.of<Authentication>(context, listen: false).getAddressBook.lastName.toString();
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.only(right: size.height > 412 ? 120.0: 350.0),
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    CustomTextField(
                      ...
                      hitText: "Mobile Number (Optional)",
                    ),
                    CustomTextField(
