    ...
    return  Container(
          ...
          child: Padding(
            ...
            child:   Consumer<Cart>(
                ...
                children: [
                  Center(child: Text('Express Delivery', style: TextStyle(color: kBrandColor, fontSize: 24.0),)),
                  Container(
                   margin: EdgeInsets.only(top: 30.0, left:30.0, right: 30.0),
                    child: Text('Set Closet location to you, ${currentSelectedValue == null ? " ": currentSelectedValue}')),
                  Container(
                    margin: EdgeInsets.only(top: 10.0, left:30.0, right: 30.0),
                    padding: EdgeInsets.all(10.0),
                    width: size.width / 1.1,
                    height: size.height > 412 ? size.height * 0.0699 : size.height * 0.1399,
                    decoration: BoxDecoration(
                    ...
                    child:  DropdownButton<String>(
                        underline: SizedBox(),
                        isExpanded: true,
                        hint: checkOut.expressPickUpPlace == null ?  Text("Choose a Location"): Text(checkOut.expressPickUpPlace.toString()),
                    ...
                    Container(
                        ...
                        child: FlatButton(
                          ...
                          print(checkOut.getExpressPickUpAddress);
                                Navigator.pop(context, checkOut.getExpressPickUpAddress);
                          },
                          child: Text(
                                'Save Changes',
