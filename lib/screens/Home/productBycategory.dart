...
// import 'package:nutloop_ecommerce/screens/Home/mainPage.dart';
...
class _ProductsByCategoryState extends State<ProductsByCategory> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<List<ProductModel>> _future = Provider.of<ProductsProvider>(context, listen: false).findProductByCategory(widget.categoryId);
    return Scaffold(
      key: _scaffoldKey,
                    ...
                    Consumer<ProductsProvider>(builder: (context, prod, child) {
                        ...
                        return  Container(
                                ...
                                child: GridView.count(
                                  ...
                                  childAspectRatio:
                                       size.height > 412 ? size.height / 950 : size.height * 0.0050,
                                  mainAxisSpacing: 5.0,
                                  physics: NeverScrollableScrollPhysics(),
                                  children: List.generate(
                                      products == null ? 0 : products.length, (i) {
                                    final x = products[i];
                                              ...
                                              Navigator.push(
                                                  ...
                                                  MaterialPageRoute(
                                                      builder: (context) => ProductDetails(
                                                          ...
                                                          double.parse(Provider.of<ProductsProvider>(
                                                                          context,
                                                                          listen:
                                                                              false)
                                                                      .getMeasurement ==
