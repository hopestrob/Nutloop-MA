  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
          ...
          key: _scaffoldKey,
          body: Consumer<CartProvider>(builder: (context, ordersDetail, child) {
            var ordersDetails = ordersDetail.getOrderedItem;
            print(
                'this is the ordersDetail status ${ordersDetail.orderLoaded}');
            ...
            return Column(children: [
              ...
              ordersDetail.orderNetwork == true
                  ? Container(
                      margin: EdgeInsets.all(15.0),
                      child: Text(ordersDetail.orderNetworkString.toString()),
                    )
                  : ordersDetail.orderLoaded == false
                      ? Container(
                          width: 200.0,
                          height: 200,
