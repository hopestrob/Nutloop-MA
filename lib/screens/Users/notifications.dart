    ...
    return Scaffold(
        ...
        body: SafeArea(
          child: Column(children: [
            Container(child: header(context, "Notifications")),
            SizedBox(height: 10),
            Expanded(
                child: Container(
              color: greyColor5,
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: new SwitchListTile(
                              ...
                              title: new Text('Order Tracking',
                                  style: new TextStyle(
                                      fontSize: 20.0, color: greyColor2)),
                          ...
                          Padding(
                            ...
                            child: new SwitchListTile(
                              ...
                              inactiveThumbColor: Colors.white,
                              activeColor: kBrandColor,
                              title: new Text('Discount & Sales',
                                  style: new TextStyle(
                                      fontSize: 20.0, color: greyColor2)),
                              subtitle:
                                  Text('Notify me on promo and Best Sales'),
                            ),
                          ),
                          line(context),
                          Padding(
                            ...
                            child: new SwitchListTile(
                              ...
                              inactiveThumbColor: Colors.white,
                              activeColor: kBrandColor,
                              title: new Text('Stocks Notifications',
                                  style: new TextStyle(
                                      fontSize: 20.0, color: greyColor2)),
                              subtitle: Text(
                                  'Notify me when an out of stock product is available'),
                            ),
                          ),
                        ],
                      ),
